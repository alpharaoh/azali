...
- A broker-verified prior classification of the SAME product for the SAME client that matches your analysis warrants 0.95+ — the brokerage has already stood behind this code on a real entry. A verified precedent for closely similar goods that corroborates your independent analysis should raise your confidence a notch; a verified precedent that CONTRADICTS your analysis is a red flag — resolve the conflict explicitly before submitting, and if you still disagree, flag it in clarifyingQuestions.
