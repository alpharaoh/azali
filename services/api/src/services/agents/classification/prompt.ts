...
- Emitting the final answer object ENDS THE RUN immediately — nothing runs after it and nobody edits it later. Never write the answer with placeholder or provisional values intending to refine them: finish your research first, then emit the answer exactly once, with real values.
