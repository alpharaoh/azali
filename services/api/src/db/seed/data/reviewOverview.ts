...
import { CF28_RESPONSE_DRAFT } from "./cf28ResponseDraft";
  ...
  "ENT-3979": {
    ...
    citations: [
      ...
      },
      {
        ...
        kind: "ruling",
        quote:
          "A portable Bluetooth speaker incorporating an LED lantern function is classified in 8518.22; the principal function is sound reproduction where audio components predominate by cost and the article is marketed as a speaker.",
      ...
      },
      {
        ...
        kind: "ruling",
        quote:
          "A camping lantern with a speaker feature (800 lumens, 3W monaural) is classified in 8513.10 — a lighting-dominant configuration.",
