    ...
    documents: [
      {
        ...
        subject:
          "ENT-4471 — full doc set for LA/Long Beach, vessel due Thursday",
      ...
      },
      {
        ...
        lines: [
          ...
          { label: "Terms", value: "FOB Shanghai (Incoterms 2020)" },
          {
            highlight: true,
            label: "Lines",
            value: "24 line items · Ch. 85 (14) · Ch. 94 (7) · Ch. 39 (3)",
          },
          {
            label: "Largest line",
            value: "Smart kettle SK-8 · 4,100 pcs @ $16.40",
          },
          {
            highlight: true,
            label: "Total invoice value",
            value: "USD 186,400.00",
          },
        ],
      },
      {
        ...
        lines: [
          { label: "Reference", value: "PRI-3301 · PO-77841" },
          {
            highlight: true,
            label: "Totals",
            value: "480 cartons · 18,340 units · G.W. 6,480 kg",
          },
          { label: "Container", value: "1 × 40' HC · floor-loaded" },
          {
            label: "Marks",
            value: "PACIFIC RIM / LA · C/NO 1-480 · MADE IN CHINA",
          },
        ],
      },
      {
        ...
        lines: [
          { label: "B/L", value: "COSU7719402113 · SCAC COSU" },
          {
            highlight: true,
            label: "Vessel",
            value: "COSCO Harmony 112E · Shanghai → LA/Long Beach",
          },
    ...
    documents: [
      ...
      },
      {
        ...
        lines: [
          ...
          {
            highlight: true,
            label: "Σ line items (1–12)",
            value: "USD 45,780.00",
          },
          {
            highlight: true,
            label: "Total (printed, p.2)",
            value: "USD 48,250.00 — disagrees by $2,470",
          },
      ...
      },
      {
        ...
        lines: [
          { label: "Reference", value: "PL-88231 · matches INV-88231" },
          {
            ...
            label: "Corroboration",
            value:
              "Quantities and unit prices agree with lines 1–12 (24/24 fields)",
          },
  ...
  "SHP-2214": {
    documents: [
      {
        ...
        lines: [
          ...
          {
            label: "Line 1",
            value: "USB-C cables (2m) · $6,200 — catalog match",
          },
          {
            label: "Line 2",
            value: "Mesh extender EX-3 · $14,800 — catalog match",
          },
          {
            highlight: true,
            label: "Line 3",
            value:
              "AX5400 tri-band mesh router, 2-pack (RBK762) · 2,400 packs · $128,000",
          },
          {
            highlight: true,
            label: "Country of origin",
            value: "Taiwan — outside the Section 301 lists",
          },
      ...
      },
      {
        ...
        lines: [
          {
            label: "System",
            value: "Tri-band Wi-Fi 6 mesh · router + satellite per retail pack",
          },
          {
            highlight: true,
            label: "Function",
            value: "Wireless reception, conversion & transmission of data",
          },
      ...
      },
      {
        ...
        lines: [
          ...
          { label: "Ruling date", value: "March 2022" },
          {
            label: "Relevance",
            value:
              "Closest precedent — same principal function, same set question",
          },
        ],
      },
      {
        ...
        lines: [
          {
            ...
            value: "8517.62.0090 · confidence 0.87",
          },
          { label: "Alternate", value: "8517.69.0000 · confidence 0.11" },
          {
            label: "Why reviewed",
            value:
              "GRI 3(b) set question caps confidence below the 95% auto-file line",
          },
          {
            label: "Precedent",
            value: "NY N324089 · catalog match on the EX-3 extender",
          },
        ],
    ...
    alternates: [
      ...
      },
      {
        value: "8471.80.1000",
        detail:
          "Automatic data processing units \u2014 network hubs and similar",
        confidence: 0.06,
        reason:
      ...
      },
      {
        value: "8517.71.0000",
        detail:
          "Aerials and antennas; parts suitable for use with 8517 apparatus",
        confidence: 0.03,
        reason:
      ...
      },
      {
        ...
        lines: [
          { label: "Certificate", value: "RM-2026-1188 · Lot 44-A" },
          {
            highlight: true,
            label: "Lab result",
            value: "55.2% wool / 44.8% polyester by weight (ISO 1833)",
          },
          { label: "Sampling", value: "3 specimens · shell fabric only" },
          {
            label: "Margin",
            value: "5.2 points above the 50% chief-weight line",
          },
        ],
      },
      {
        ...
        lines: [
          {
            highlight: true,
            label: "Recommendation",
            value: "6204.31.20 (wool chief weight) · confidence 0.82",
          },
          {
            label: "Alternate",
            value: "6204.33.5010 (synthetic) · confidence 0.28 · +$6,035 duty",
          },
          {
            label: "Legal frame",
            value:
              "Ch. 62, Subheading Note 2 — chief-weight fibre of the shell",
          },
          {
            label: "Precedent",
            value: "HQ 960950 — 55/45 wool-poly blazer → 6204.31",
          },
        ],
    ...
    documents: [
      {
        ...
        lines: [
          ...
          {
            label: "Modes",
            value: "Red (630nm) · blue (415nm) · 10-min auto cycle",
          },
      ...
      },
      {
        ...
        lines: [
          {
            label: "Front panel",
            value: "\u201cLED Beauty Mask — glow at home\u201d",
          },
          {
            highlight: true,
            label: "Back panel",
            value: "Wellness language only — no treatment or cure claims",
          },
          {
            label: "Inserts",
            value:
              "Usage guide references \u201cskin rejuvenation routine\u201d",
          },
          {
            label: "Markings",
            value: "CE · FCC · \u201cnot a medical device\u201d absent",
          },
        ],
      },
      {
        ...
        lines: [
          {
            highlight: true,
            label: "Determination",
            value: "FDA DEV flag required · confidence 0.74",
          },
          {
            label: "Basis",
            value:
              "21 CFR §878.4810 — light-based devices for medical purposes",
          },
          {
            label: "Exemption",
            value:
              "General-wellness exemption likely unavailable on current claims",
          },
          {
            label: "Forward fix",
            value:
              "Artwork/claims cleanup could restore the exemption on future POs",
          },
        ],
    ...
    documents: [
      {
        ...
        lines: [
          { label: "Invoice", value: "INV-4471 · intercompany" },
          {
            highlight: true,
            label: "Seller",
            value: "Bosch Fertigung GmbH (parent company)",
          },
          { label: "Part", value: "RW-4471 sensor housing" },
          {
            highlight: true,
            label: "Unit price",
            value: "$8.40 × 11,000 units = $92,400",
          },
          { label: "Terms", value: "FCA Hamburg (Incoterms 2020)" },
          {
            label: "Relationship",
            value: "Buyer and seller under common control",
          },
        ],
      },
      {
        ...
        lines: [
          { label: "Method", value: "TNMM · tested party: US distributor" },
          {
            ...
            value: "Operating margin 2.1%–4.8% · tested result 3.4%",
          },
        ...
        lines: [
          {
            ...
            value: "$10.25/unit (n = 7 entries)",
          },
          { label: "This invoice", value: "$8.40/unit (−18%)" },
          {
            label: "Prior related-party entries",
            value: "$8.35–8.55/unit · all liquidated without question",
          },
          {
            label: "Volume",
            value:
              "Parent supplies at contract volume; unrelated sellers quote spot",
          },
        ],
      },
      {
        ...
        lines: [
          {
            highlight: true,
            label: "Recommendation",
            value: "Accept transaction value · confidence 0.71",
          },
          {
            label: "Legal frame",
            value: "19 USC §1401a(b)(2)(B) — circumstances of sale",
          },
          {
            label: "Support",
            value:
              "TP study in range · consistent prior pricing · volume explanation",
          },
          {
            label: "Risk",
            value: "§1592 exposure reaches prior entries at the same price",
          },
        ],
        ...
        lines: [
          {
            highlight: true,
            label: "Change",
            value: "6404.11.90 subdivided by constituent material of the upper",
          },
          { label: "Effective", value: "Current period (mid-year revision)" },
          {
            label: "Summit SKUs affected",
            value: "132 · 129 auto-reassigned · 3 manual",
          },
          {
            label: "Duty",
            value: "20% under both old and new lines — statistical change only",
          },
        ],
      },
      {
        ...
        lines: [
          { label: "Style", value: "TR-9 trail runner" },
          {
            ...
            label: "Upper",
            value:
              "78% textile mesh / 22% synthetic overlays (by surface area)",
          },
          { label: "Sole", value: "Rubber · cemented construction" },
          {
            highlight: true,
            label: "Value",
            value: "$13.58/pair — over the $12 statistical line",
          },
        ...
        lines: [
          {
            highlight: true,
            label: "Recommendation",
            value: "6404.11.90 (new statistical suffix) · confidence 0.91",
          },
          {
            label: "Basis",
            value: "Textile upper controls (78% by surface) · >$12/pair",
          },
          {
            label: "Duty impact",
            value: "$0 — ten-digit statistical change only",
          },
        ],
      ...
      },
      {
        ...
        lines: [
          ...
          { label: "Unit price", value: "$1,026.43 · total $143,700" },
          {
            highlight: true,
            label: "Country of origin",
            value: "(blank) — required for entry",
          },
        ...
        lines: [
          {
            highlight: true,
            label: "Declaration",
            value: "Country of origin: Germany (Nürnberg plant)",
          },
          { label: "Scope", value: "Part RW-2205, all serials this shipment" },
          {
            label: "Signed",
            value: "K. Brandt, Export Compliance · Rheinwerk Präzision",
          },
        ],
      },
      {
    ...
    documents: [
      {
        ...
        lines: [
          ...
          {
            label: "Terms",
            value: "FOB Ningbo-Zhoushan (Incoterms 2020) · Net 30",
          },
          {
            label: "Transport",
            value: "Ocean · COSCO Universe 095E · B/L COSU6398471250",
          },
          {
            highlight: true,
            label: "Line 1",
            value:
              "2,400 × LUX-SP210 @ $18.75 — “LED table lamp with integrated Bluetooth speaker”",
          },
          {
            label: "Line 2",
            value: "2,400 × lamp shade/diffuser @ $1.10 (9405.92.0000)",
          },
          {
            label: "Line 3",
            value: "120 × USB-C cable kit @ $2.30 (8544.42.9090)",
          },
          {
            highlight: true,
            label: "Supplier HTS note",
            value:
              "8513.10.40 suggested — “as entered: 8518.22.0000, under CBP review”",
          },
          {
            label: "Packing",
            value: "200 cartons · 1 × 20' FCL · G.W. 3,120 kg",
          },
          {
            highlight: true,
            label: "Total invoice value",
      ...
      },
      {
        ...
        lines: [
          ...
          {
            label: "Line 2",
            value: "30 ctn · 2,400 pcs shade/diffuser (LSP210-DIF) · 360 kg",
          },
          {
            label: "Line 3",
            value: "10 ctn · 120 sets USB-C kit (LSP210-CBL) · 120 kg",
          },
          {
            highlight: true,
            label: "Totals",
          ...
          {
            label: "Handling",
            value: "Li-ion batteries UN3481, PI 967 · keep dry",
          },
      ...
      },
      {
        ...
        lines: [
          ...
          {
            label: "Carrier",
            value: "COSCO Shipping Lines / Norton Lilly (inland)",
          },
          {
            highlight: true,
            label: "Container",
          ...
          {
            label: "Freight",
            value: "3rd party — billed to the importer of record",
          },
          {
            label: "Cargo",
            value: "200 cartons · 3,120 kg gross · 1 × 20' FCL",
          },
          {
            highlight: true,
            label: "Declared value",
            value: "USD 48,556.00 · FOB Ningbo",
          },
          {
            highlight: true,
          ...
          {
            label: "Pickup",
            value: "22 Jan · signed W. Zhang / M. Torres (COSCO)",
          },
        ],
      },
      {
        ...
        lines: [
          {
            label: "Product",
            value: "LUX-SP210 · ref LSP210-BLK · PO-88231 · rev. 2",
          },
          {
            label: "Audio",
            value:
              "3W full-range driver · BT 5.0 · tuned aluminium enclosure · SNR ≥ 80 dB",
          },
          {
            label: "Lighting",
            value: "Dimmable LED ring · 3 settings · 2700 K · frosted diffuser",
          },
          {
            label: "Power",
            value:
              "5,000 mAh Li-ion · USB-C · ≥ 8 h audio / ≥ 12 h light · UN38.3",
          },
          {
            highlight: true,
            label: "Cost contribution",
            value:
              "Audio 55% · power 25% · lighting 20% — “for classification & valuation support”",
          },
          {
            highlight: true,
          ...
          },
          {
            ...
            value: "15/carton · 160 cartons · 2,400 pcs · gross 3,120 kg",
          },
          {
            label: "Compliance",
            value: "CE · FCC 15B · RoHS · UN38.3 / UN3481 (PI 967)",
          },
        ],
      },
      {
        ...
        lines: [
          {
            highlight: true,
            label: "Recommendation",
            value: "8513.10.40 · confidence 0.84",
          },
          { label: "Alternate", value: "8518.22.0000 · confidence 0.62" },
          {
            label: "Legal frame",
            value: "Section XVI, Note 3 — principal function",
          },
          {
            label: "Precedent",
            value: "NY N305672 (supporting) · NY N327431 (distinguished)",
          },
        ],
      ...
      },
      {
        ...
        lines: [
          ...
          },
          {
            ...
            label: "CBP asks",
            value:
              "Essential character under GRI 3(b) — which component predominates by cost, weight, consumer use",
          },
          {
            label: "Furnish",
            value:
              "B — product literature · C — component cost breakdown · D — sample (LUX-SP210)",
          },
          {
            label: "Officer message",
            value:
              "“Invoice and retail packaging describe the article primarily as a LED table lamp…”",
          },
          {
            label: "Entries covered",
            value: "ENT-3979 (entered 10/18) + 10 open entries",
          },
          {
            label: "Reply window",
            value: "30 days from request (19 USC §1509) · via ACE",
          },
          {
            label: "From",
            value:
              "Import Specialist D. Okafor · NIS Team 733 · New York/Newark (1001)",
          },
        ],
      },
      {
        ...
        lines: [
          {
            ...
            label: "Position",
            value:
              "Concede 8513.10.40 — per the rationale memo written at entry",
          },
          {
            label: "Legal frame",
            value: "Section XVI, Note 3 — principal function is illumination",
          },
          {
            label: "Precedent",
            value: "NY N305672 (controlling) · NY N327431 (distinguished)",
          },
          {
            highlight: true,
            label: "Corrective action",
            value:
              "Tender +$1,700 this entry · ~$19K across 11 entries · no-penalty request",
          },
          {
            label: "Exhibits",
            value:
              "A spec · B photos · C cost breakdown · D packaging · E rationale memo",
          },
        ],
