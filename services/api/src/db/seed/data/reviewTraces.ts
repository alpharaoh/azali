  ...
  "ENT-3979": [
      ...
      steps: [
        {
          ...
          detail:
            "Parsed the ACE notification. CBP is probing whether the lamp function makes the LUX-SP210 a lamp — a principal-function dispute, and the response clock started at issuance.",
          kind: "read",
        ...
        },
        {
          ...
          detail:
            "The Form 28 demands product literature, component cost data, and marketing materials — exactly the records §1509 entitles CBP to examine. All three already exist in the file.",
          kind: "check",
    ...
    },
    {
      ...
      steps: [
        {
          detail:
            "Retrieved the entry file: commercial invoice AZ-INV-20259-4471, LUX-SP210 spec sheet, the filed 7501, and the classification rationale memo written at first entry. Retrieval, not excavation.",
          kind: "lookup",
        ...
        },
        {
          ...
          detail:
            "Cost composition, design emphasis, and marketing all point the same direction: the article is a speaker with a lamp feature, not the inverse.",
          kind: "read",
        ...
        },
        {
          ...
          detail:
            "A consistent, unchallenged entry history is the core of the reasonable-care record.",
          kind: "check",
      ...
      steps: [
        {
          ...
          detail:
            "The controlling analog: a lighting-dominant lantern with speaker feature classifies in 8513.10 — the same conclusion the rationale memo reached at entry.",
          kind: "lookup",
        ...
        },
        {
          ...
          detail:
            "The ruling the override leaned on is distinguishable on its facts — the LUX-SP210 is not the audio-dominant article it describes.",
          kind: "check",
      ...
      steps: [
        {
          ...
          detail:
            "Computed the tender the concession requires — and the §1592 mitigation the entry-time memo buys.",
          kind: "calc",
      ...
      steps: [
        {
          ...
          detail:
            "Drafted the corrected response: concede 8513.10.40 per the entry-time memo, tender the difference, request no penalties on the documented reasonable-care record.",
          kind: "decision",
          title: "Drafted the corrected response",
        },
        {
          detail:
            "Form 28 responses require licensed sign-off before transmission — everything filed here becomes the §1592 record if CBP escalates to a Form 29.",
          kind: "flag",
