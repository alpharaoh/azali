 ...
 */
export type ListShipmentEmailsResponseDtoEmailsItemStatus =
  (typeof ListShipmentEmailsResponseDtoEmailsItemStatus)[keyof typeof ListShipmentEmailsResponseDtoEmailsItemStatus];
 ...
 */
export type ConnectEmailAccountDtoProvider =
  (typeof ConnectEmailAccountDtoProvider)[keyof typeof ConnectEmailAccountDtoProvider];
...
export type shipmentsControllerEmailsResponseSuccess =
  shipmentsControllerEmailsResponse200 & {
    headers: Headers;
  };

export type shipmentsControllerEmailsResponse =
  shipmentsControllerEmailsResponseSuccess;

export const getShipmentsControllerEmailsUrl = (id: string) => {
  return `/v1/shipments/${id}/emails`;
};

export const shipmentsControllerEmails = async (
  id: string,
  options?: RequestInit,
): Promise<shipmentsControllerEmailsResponse> => {
  return axios<shipmentsControllerEmailsResponse>(
    getShipmentsControllerEmailsUrl(id),
    {
      ...options,
      method: "GET",
    },
...
export const getShipmentsControllerEmailsQueryKey = (id: string) => {
  return [`/v1/shipments/${id}/emails`] as const;
};

export const getShipmentsControllerEmailsQueryOptions = <
  TData = Awaited<ReturnType<typeof shipmentsControllerEmails>>,
  TError = ErrorType<unknown>,
>(
  id: string,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getShipmentsControllerEmailsQueryKey(id);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof shipmentsControllerEmails>>
  > = ({ signal }) =>
    shipmentsControllerEmails(id, { signal, ...requestOptions });
...
export type ShipmentsControllerEmailsQueryResult = NonNullable<
  Awaited<ReturnType<typeof shipmentsControllerEmails>>
>;
export type ShipmentsControllerEmailsQueryError = ErrorType<unknown>;

export function useShipmentsControllerEmails<
  TData = Awaited<ReturnType<typeof shipmentsControllerEmails>>,
  TError = ErrorType<unknown>,
>(
  id: string,
...
export type shipmentsControllerSkipEmailIntakeResponseSuccess =
  shipmentsControllerSkipEmailIntakeResponse201 & {
    headers: Headers;
  };

export type shipmentsControllerSkipEmailIntakeResponse =
  shipmentsControllerSkipEmailIntakeResponseSuccess;

export const getShipmentsControllerSkipEmailIntakeUrl = (id: string) => {
  return `/v1/shipments/${id}/skip-email-intake`;
};

export const shipmentsControllerSkipEmailIntake = async (
  id: string,
  options?: RequestInit,
): Promise<shipmentsControllerSkipEmailIntakeResponse> => {
  return axios<shipmentsControllerSkipEmailIntakeResponse>(
    getShipmentsControllerSkipEmailIntakeUrl(id),
    {
      ...options,
      method: "POST",
    },
...
export const getShipmentsControllerSkipEmailIntakeMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type ShipmentsControllerSkipEmailIntakeMutationResult = NonNullable<
  Awaited<ReturnType<typeof shipmentsControllerSkipEmailIntake>>
>;

export type ShipmentsControllerSkipEmailIntakeMutationError =
  ErrorType<unknown>;

/**
 * @summary Skip the email intake window
 */
export const useShipmentsControllerSkipEmailIntake = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(
  options?: {
...
> => {
  return useMutation(
    getShipmentsControllerSkipEmailIntakeMutationOptions(options),
    queryClient,
  );
};
...
export type emailAccountsControllerConnectResponseSuccess =
  emailAccountsControllerConnectResponse201 & {
    headers: Headers;
  };

export type emailAccountsControllerConnectResponse =
  emailAccountsControllerConnectResponseSuccess;

export const getEmailAccountsControllerConnectUrl = () => {
  return `/v1/email-accounts/connect`;
};

export const emailAccountsControllerConnect = async (
  connectEmailAccountDto: ConnectEmailAccountDto,
  options?: RequestInit,
): Promise<emailAccountsControllerConnectResponse> => {
  return axios<emailAccountsControllerConnectResponse>(
    getEmailAccountsControllerConnectUrl(),
    {
      ...options,
      method: "POST",
      headers: { "Content-Type": "application/json", ...options?.headers },
      body: JSON.stringify(connectEmailAccountDto),
    },
  );
};

export const getEmailAccountsControllerConnectMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type EmailAccountsControllerConnectMutationResult = NonNullable<
  Awaited<ReturnType<typeof emailAccountsControllerConnect>>
>;
 ...
 * @summary Connect an inbox
 */
export const useEmailAccountsControllerConnect = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(
  options?: {
...
> => {
  return useMutation(
    getEmailAccountsControllerConnectMutationOptions(options),
    queryClient,
  );
};
...
export type emailAccountsControllerListResponseSuccess =
  emailAccountsControllerListResponse200 & {
    headers: Headers;
  };

export type emailAccountsControllerListResponse =
  emailAccountsControllerListResponseSuccess;

export const getEmailAccountsControllerListUrl = () => {
  return `/v1/email-accounts`;
};

export const emailAccountsControllerList = async (
  options?: RequestInit,
): Promise<emailAccountsControllerListResponse> => {
  return axios<emailAccountsControllerListResponse>(
    getEmailAccountsControllerListUrl(),
    {
      ...options,
      method: "GET",
    },
...
export const getEmailAccountsControllerListQueryKey = () => {
  return [`/v1/email-accounts`] as const;
};

export const getEmailAccountsControllerListQueryOptions = <
  TData = Awaited<ReturnType<typeof emailAccountsControllerList>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: Partial<
    UseQueryOptions<
  ...
  const queryKey =
    queryOptions?.queryKey ?? getEmailAccountsControllerListQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof emailAccountsControllerList>>
  > = ({ signal }) =>
    emailAccountsControllerList({ signal, ...requestOptions });
...
export type EmailAccountsControllerListQueryResult = NonNullable<
  Awaited<ReturnType<typeof emailAccountsControllerList>>
>;
export type EmailAccountsControllerListQueryError = ErrorType<unknown>;

export function useEmailAccountsControllerList<
  TData = Awaited<ReturnType<typeof emailAccountsControllerList>>,
  TError = ErrorType<unknown>,
>(
  options: {
...
export type emailAccountsControllerDisconnectResponseSuccess =
  emailAccountsControllerDisconnectResponse200 & {
    headers: Headers;
  };

export type emailAccountsControllerDisconnectResponse =
  emailAccountsControllerDisconnectResponseSuccess;

export const getEmailAccountsControllerDisconnectUrl = (id: string) => {
  return `/v1/email-accounts/${id}`;
};

export const emailAccountsControllerDisconnect = async (
  id: string,
  options?: RequestInit,
): Promise<emailAccountsControllerDisconnectResponse> => {
  return axios<emailAccountsControllerDisconnectResponse>(
    getEmailAccountsControllerDisconnectUrl(id),
    {
      ...options,
      method: "DELETE",
    },
...
export const getEmailAccountsControllerDisconnectMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type EmailAccountsControllerDisconnectMutationResult = NonNullable<
  Awaited<ReturnType<typeof emailAccountsControllerDisconnect>>
>;
 ...
 * @summary Disconnect an inbox
 */
export const useEmailAccountsControllerDisconnect = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(
  options?: {
...
> => {
  return useMutation(
    getEmailAccountsControllerDisconnectMutationOptions(options),
    queryClient,
  );
};
